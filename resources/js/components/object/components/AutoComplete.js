...
export default function Highlights() {
    let validateString = (value) => {
        const globalRegex = RegExp('([а-я]+)\\s([а-я]+)-([а-я]+)','gm');
        return globalRegex.test(value);
    }

    const globalState = useStoreContext();

    let {address, ymaps, validAddressField} = globalState;

    const { changeMap, updateText, checkNotEmptyAddressFields} = useStoreActions();
            ...
            <div className={'setting__info'}>
                <div className="form__inner">
                    <label> <span className="initial">Страна*</span>
                        <img src="/img/flag/1.png" alt="Flag" className="flag__russia" width="22" height="22"/>
                        <Autocomplete
                            id="highlights-demo"
                            style={{width: "100%"}}
                            options={top100Films}
                            ...
                            renderInput={params => (
                                <TextField type={"text"} required {...params}  error={validateString(address.country)} label="Страна" variant="outlined"
                                           margin="normal"/>
                            )}


                            onBlur={(evt) => updateText('country', evt.target.value, 'address')}
                ...
                <div className="form__inner">
                    <label> <span className="initial">Регион*</span>
                        ...
                        <Autocomplete
                            ...
                            options={regions}
                            getOptionLabel={option => typeof option === 'string' ? option : option.id}
                            value={address.region.trim()}
                            renderInput={params => (
                                <TextField  required {...params} error={validateString(address.region)} label="Регион" variant="outlined"
                                           margin="normal"/>
                            )}
                            onBlur={(evt) => updateText('region', evt.target.value, 'address')}
                            renderOption={(option, {inputValue}) => {
                                const matches = match(option.id, inputValue);
                                const parts = parse(option.id, matches);
                ...
                <div className="form__inner">
                    <label> <span className="initial">Район</span>
                        <TextField  label="Район" onChange={(evt) => {updateText('area', evt.target.value,'address')}} value={address.area} error={validateString(address.area)} onBlur={(evt) => updateText('area', evt.target.value, 'address')} variant="outlined"  margin="normal"/>
                    </label>
                </div>
                <div className="form__inner">
                    <Dadata />
                ...
                <div className="form__inner">
                    <label> <span className="initial">Город*</span>
                        <Autocomplete
                            ...
                            renderInput={params => (
                                <TextField  error={validateString(address.city)} required {...params} label="Город" variant="outlined"
                                           margin="normal"/>
                            )}
                            onBlur={(evt) => updateText('city', evt.target.value, 'address')}
                            renderOption={(option, {inputValue}) => {
                ...
                <div className="form__inner">
                    <label> <span className="initial">Округ</span>
                        <TextField value={address.district} onChange={(evt) => {updateText('district', evt.target.value, 'address')}} error={validateString(address.district)}  onBlur={(evt) => updateText('district', evt.target.value, 'address')} placeholder="Если есть" variant="outlined"  margin="normal"/>
                    </label>
                </div>
            </div>
            <div className="setting__info one">
                <div className="form__inner">
                    <label> <span className="initial"> Микрорайон </span>
                        <TextField value={address.community} onChange={(evt) => {updateText('community', evt.target.value, 'address')}} error={validateString(address.community)} onBlur={(evt) => {updateText('community', evt.target.value, 'address')}} placeholder={'Если есть'} variant="outlined"  margin="normal"/>

                    </label>
                </div>

                <div className="form__inner">
                    <label> <span className="initial">Улица*</span>

                        <TextField value={address.string} onChange={(evt) => updateText('string',evt.target.value,'address')} error={validateString(address.string)} onBlur={(evt) => updateText('string', evt.target.value,'address')} required placeholder={'Меньшикова'} variant="outlined"  margin="normal"/>

                    </label>
                </div>

                <div className="form__street">
                    <div className="form__inner  street">
                        <label style={{display: 'flex', flexDirection: 'column'}}> <span className="initial">Дом*</span>
                            <TextField required value={address.house} onChange={(evt) => {updateText('house', evt.target.value, 'address')}} onBlur={() => {
                                checkNotEmptyAddressFields(address);
                                changeMap(address,ymaps, validAddressField);


                            }} placeholder={'2'}  style={{width: '50px'}} className="street"
                    ...
                    <div className="form__inner street">
                        <label style={{display: 'flex', flexDirection: 'column'}}> <span
                            className="initial">Корпус*</span>
                            <TextField value={address.housing} onChange={(evt) => {updateText('housing', evt.target.value, 'address')}} onBlur={(evt) => updateText('housing', evt.target.value, 'address')} required placeholder={'3'} style={{width: '50px'}} className="street"
                                       variant="outlined"  margin="normal"/>
...
const top100Films = JSON.parse('[{"id":"Афганистан"},{"id":"Албания"},{"id":"Алжир"},{"id":"Самоа"},{"id":"Андорра"},{"id":"Ангола"},{"id":"Ангилья"},{"id":"Антигуа и Барбуда"},{"id":"Аргентина"},{"id":"Армения"},{"id":"Аруба"},{"id":"Австралия"},{"id":"Австрия "},{"id":"Азербайджан"},{"id":" Бахрейн"},{"id":"Бангладеш"},{"id":"Барбадос"},{"id":"Белоруссия"},{"id":"Бельгия"},{"id":" Бенин"},{"id":"Бермуды"},{"id":"Бутан"},{"id":"Боливия"},{"id":"Босния и Герцеговина"},{"id":"Ботсвана"},{"id":"Бразилия "},{"id":"Бруней"},{"id":"Болгария"},{"id":"Буркина-Фасо"},{"id1":"Бирма (Мьянма)"},{"id":"Бурунди"},{"id":"Камбоджа"},{"id":"Камерун"},{"id":"Канада"},{"id":"Канарские острова"},{"id":"Кабо-Верде"},{"id":"Центральноафриканская Республика"},{"id":"Чад"},{"id":"Чили"},{"id":"Китай"},{"id":"Колумбия"},{"id":"Коморы"},{"id":"Конго"},{"id":"Коста-Рика"},{"id":"Хорватия"},{"id":"Куба"},{"id":"Кипр"},{"id":"Чехия"},{"id":"Дания"},{"id":"Джибути"},{"id":"Доминика"},{"id":"Доминиканская Республика"},{"id":"Эквадор"},{"id":"Египет"},{"id":"Сальвадор"},{"id":"Экваториальная Гвинея"},{"id":"Эритрея"},{"id":"Эстония"},{"id":"Эфиопия"},{"id":"Фолклендские острова"},{"id":"Фиджи"},{"id":"Финляндия"},{"id":"Франция"},{"id":"Французская Гвиана"},{"id":"Французская Полинезия"},{"id":"Габон"},{"id":"Грузия"},{"id":"Германия"},{"id":"Гана"},{"id":"Гибралтар"},{"id":"Греция"},{"id":"Гренландия"},{"id":"Гренада"},{"id":"Гваделупа"},{"id":"Гуам"},{"id":"Гватемала"},{"id":"Гвинея"},{"id":"Гвинея-Бисау"},{"id":"Гайана"},{"id":"Гаити"},{"id":"Гондурас"},{"id":"Венгрия"},{"id":"Исландия"},{"id":"Индия"},{"id":"Индонезия"},{"id":"Иран"},{"id":"Ирак"},{"id":"Ирландия"},{"id":"Израиль"},{"id":"Италия"},{"id":"Кот-д’Ивуар"},{"id":"Ямайка"},{"id":"Япония"},{"id":"Джонстон (атолл)"},{"id":"Иордания"},{"id":"Турецкая Республика Северного Кипра"},{"id":"Казахстан"},{"id":"Кения"},{"id":"Французские Южные и Антарктические Территории"},{"id":"Кирибати"},{"id":"Кувейт"},{"id":"Кыргызстан"},{"id":"Лаос"},{"id":"Латвия"},{"id":"Ливан"},{"id":"Лесото"},{"id":"Либерия"},{"id":"Ливия"},{"id":"Литва"},{"id":"Люксембург"},{"id":"Республика Македония"},{"id":"Мадагаскар"},{"id":"Малави"},{"id":"Малайзия"},{"id":"Мальдивы"},{"id":"Мали"},{"id":"Мальта"},{"id":"Маршалловы Острова"},{"id":"Мартиника"},{"id":"Мавритания"},{"id":"Маврикий"},{"id":"Мексика"},{"id":"Федеративные Штаты Микронезии"},{"id":"Мидуэй"},{"id":"Молдавия"},{"id":"Монако"},{"id":"Монголия"},{"id":"Монтсеррат"},{"id":"Марокко"},{"id":"Мозамбик"},{"id":"Намибия"},{"id":"Непал"},{"id":"Нидерланды"},{"id":"Нидерландские Антильские острова"},{"id":"Новая Каледония"},{"id":"Новая Зеландия"},{"id":"Никарагуа"},{"id":"Нигер"},{"id":"Нигерия"},{"id":"Корейская Народно-Демократическая Республика"},{"id":"Северная Ирландия"},{"id":"Северные Марианские острова"},{"id":"Норвегия"},{"id":"Оман"},{"id":"Пакистан"},{"id":"Палау"},{"id":"Пальмира"},{"id":"Панама"},{"id":"Папуа — Новая Гвинея"},{"id":"Парагвай"},{"id":"Перу"},{"id":"Филиппины"},{"id":"Польша"},{"id":"Португалия"},{"id":"Пуэрто-Рико"},{"id":"Катар"},{"id":"Реюньон"},{"id":"Румыния"},{"id":"Россия"},{"id":"Руанда"},{"id":"Остров Святой Елены"},{"id":"Сент-Винсент и Гренадины"},{"id":"Сан-Марино"},{"id":"Саудовская Аравия"},{"id":"Сенегал"},{"id":"Сейшельские Острова"},{"id":"Сьерра-Леоне"},{"id":"Сингапур"},{"id":"Словакия"},{"id":"Словения"},{"id":"Соломоновы Острова"},{"id":"Сомали"},{"id":"Республика Корея"},{"id":"Испания"},{"id":"Шри-Ланка"},{"id":"Сент-Китс и Невис"},{"id":"Сент-Люсия"},{"id":"Швеция"},{"id":"Швейцария"},{"id":"Тайвань"},{"id":"Таджикистан"},{"id":"Таиланд"},{"id":"Гамбия"},{"id":"Тунис"},{"id":"Турция"},{"id":"Туркмения"},{"id":"Объединённые Арабские Эмираты"},{"id":"Великобритания"},{"id":"США"},{"id":"Украина"},{"id":"Узбекистан"},{"id":"Вьетнам"}]');
...
const regions = [
    ...
    {
        "id": "Иные территории, включая город и космодром Байконур"
    },
    {
